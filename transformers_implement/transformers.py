...
class SelfAttention(nn.Module):
    ...
    def foward(self, values, keys, query, mask):
        N = query.shape[0]
        ...
        # enery shepe: (N, heads, query_len, key_len)
        ...
        # after einsum (N, query_len, heads, head_dim) then flatten two dimensions
...
class DecoderBlock(nn.Module):
    def __init__(self, embed_size,heads,forward_expansion, dropout, device):
        ...
        self.attention = self.Attention(embed_size, heads)
